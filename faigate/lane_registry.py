...
_PROVIDER_LANE_BINDINGS: dict[str, dict[str, Any]] = {
    ...
    "openai-codex-5.4-xhigh": {
        ...
        "tool_strength": "medium",
        "same_model_group": "openai-codex/gpt-5.4",
        "degrade_to": ["openai-codex-5.4-high", "openai-codex-xhigh"],
    },
    "openai-codex-5.4-high": {
        ...
        "tool_strength": "medium",
        "same_model_group": "openai-codex/gpt-5.4",
        "degrade_to": ["openai-codex-5.4-medium", "openai-codex-xhigh"],
    },
    "openai-codex-5.4-medium": {
        "family": "openai",
        "name": "codex-5.4-medium",
        "canonical_model": "openai-codex/gpt-5.4",
        "route_type": "direct",
        "cluster": "elite-reasoning",
        "benchmark_cluster": "quality-coding",
        ...
        "tool_strength": "medium",
        "same_model_group": "openai-codex/gpt-5.4",
        "degrade_to": ["openai-codex-5.4-low", "openai-codex"],
    },
    "openai-codex-5.4-low": {
        ...
        "tool_strength": "medium",
        "same_model_group": "openai-codex/gpt-5.4",
        "degrade_to": ["openai-codex", "openai-codex-spark"],
    },
    "claude-code": {
        "family": "anthropic",
        "name": "code",
...
_PROVIDER_TRANSPORT_BINDINGS: dict[str, dict[str, Any]] = {
    ...
    "claude-code": {
        "profile": "oauth-anthropic-compat",
        "compatibility": "native",
        "probe_confidence": "low",
        "auth_mode": "bearer",
        "probe_strategy": "none",
        ...
        "supports_models_probe": False,
        "notes": [
            "Claude Code OAuth: Bearer token from macOS Keychain (Claude Code-credentials)",
            "Requires anthropic-beta: oauth-2025-04-20 header (injected via extra_headers)",
            "Token refresh via platform.claude.com/v1/oauth/token (single-use refresh tokens)",
        ],
    },
    "openai-codex": {
        "profile": "oauth-codex",
