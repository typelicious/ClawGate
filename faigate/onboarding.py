    ...
    *,
    ...
    integration_examples = {
        ...
        "ai-native-app": {
            ...
            "snippet": [
                "client_profiles.rules -> match on X-faigate-Client",
        ...
        "swe-af": {
            ...
            "header": "X-faigate-Client: swe-af",
            "profile": "swe-af",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "paperclip": {
            ...
            "header": "X-faigate-Client: paperclip",
            "profile": "paperclip",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "ship-faster": {
            ...
            "header": "X-faigate-Client: ship-faster",
            "profile": "ship-faster",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "langchain": {
            ...
            "header": "X-faigate-Client: langchain",
            "profile": "langchain",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "langgraph": {
            ...
            "header": "X-faigate-Client: langgraph",
            "profile": "langgraph",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "semantic-kernel": {
            ...
            "header": "X-faigate-Client: semantic-kernel",
        ...
        "haystack": {
            ...
            "header": "X-faigate-Client: haystack",
            "profile": "haystack",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "mastra": {
            ...
            "header": "X-faigate-Client: mastra",
            "profile": "mastra",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "google-adk": {
            ...
            "header": "X-faigate-Client: google-adk",
            "profile": "google-adk",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "autogen": {
            ...
            "header": "X-faigate-Client: autogen",
            "profile": "autogen",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "llamaindex": {
            ...
            "header": "X-faigate-Client: llamaindex",
            "profile": "llamaindex",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "crewai": {
            ...
            "header": "X-faigate-Client: crewai",
            "profile": "crewai",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
        ...
        "pydanticai": {
            ...
            "header": "X-faigate-Client: pydanticai",
            "profile": "pydanticai",
            "snippet": [
                "export OPENAI_BASE_URL=http://127.0.0.1:8090/v1",
                "export OPENAI_API_KEY=local",
...
def render_onboarding_validation(validation: dict[str, Any]) -> str:
    ...
    lines = [
        "fusionAIze Gate onboarding validation",
        "",
