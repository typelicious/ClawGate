...
class UpdateChecker:
    ...
    def __init__(
        ...
        *,
        ...
        self.auto_update = {
            ...
            "apply_command": str((auto_update or {}).get("apply_command", "faigate-update")),
        }
        ...
        self._client = httpx.AsyncClient(
            ...
            headers={
                ...
                "User-Agent": f"fusionAIze Gate/{current_version}",
            },
        )
    ...
    def _auto_update_status(
        ...
        *,
        ...
        apply_command = str(self.auto_update.get("apply_command", "faigate-update"))
