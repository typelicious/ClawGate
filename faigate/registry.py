...
This module defines every provider fusionAIze Gate knows about, keyed by its
...
#    These require interactive login and cannot be auto-started by fusionAIze Gate.
